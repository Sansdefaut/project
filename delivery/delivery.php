        ...
        <div class="app-content pt-2 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                    <a class="flex-sm-fill text-sm-center nav-link active" id="orders-all-tab" data-bs-toggle="tab" href="#orders-all" role="tab" aria-controls="orders-all" aria-selected="true">Success</a>
                            ...
                            <div class="app-card-body">
                                <div class="table-responsive">
                                    <table class="table app-table-hover mb-0 text-left datatable">
                                        ...
                                        <tbody>
                                            <?php 
                                     $select_allorderss = "SELECT * FROM delivery WHERE status='success' and userId='".$_SESSION['userId']."' ";
                $prepare_allorderss = $connect->prepare($select_allorderss);
                $prepare_allorderss->execute();
                $iu = 1;

                while ($fetch_allorderss = $prepare_allorderss->fetch(PDO::FETCH_ASSOC)) {
 $select_allorders = "SELECT * FROM sales WHERE salesId='".$fetch_allorderss['salesId']."' ";
           ...
           $fetch_allorders = $prepare_allorders->fetch(PDO::FETCH_ASSOC);
                                                ...
                                                $select_preorder = "SELECT * FROM cart_product WHERE salesId='".$fetch_allorderss['salesId']."'";
  ...
  $i = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td class="cell"><a class="btn-sm app-btn-secondary" href="order-delivery?ssicd=<?php echo $fetch_allorderss['deli_no']; ?>">View</a></td>
                                            </tr>
                                            <?php $iu++; } ?>
                                        </tbody>
                                    </table>
                            ...
                            <div class="app-card-body">
                                <div class="table-responsive">
                                    <table class="table app-table-hover mb-0 text-left datatable">
                                        ...
                                        <tbody>
                                            <?php 
 $select_allorderss = "SELECT * FROM delivery WHERE status='pending' and userId='".$_SESSION['userId']."' ";
                $prepare_allorderss = $connect->prepare($select_allorderss);
                $prepare_allorderss->execute();
                $iu = 1;
