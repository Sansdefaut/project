...
$select_allorders = "SELECT * FROM sales WHERE status = :paid AND DATE(dateadded) = :dates";
$prepare_allorders = $connect->prepare($select_allorders);
$prepare_allorders->execute([':paid' => 'paid', ':dates' => $sdate]);
...
?>
 FRW</div>
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100"  style="background: #E3F5FF;">
						    <div class="app-card-body p-3 p-lg-4  flex items-center justify-between">
						    	<div>
							    <h4 class="stats- text-md font-bold mb-1">All Product</h4>
							    <div class="stats-  text-lg font-extrabold text-black"><?php $select_allproduct="SELECT count(*) as countallproduct FROM users";
							    $prepare_allproduct = $connect -> prepare($select_allproduct);
							    $prepare_allproduct -> execute();
							    $fetch_allproduct = $prepare_allproduct -> fetch(PDO::FETCH_ASSOC);
							    echo $fetch_allproduct['countallproduct']; ?></div>
							</div>
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100"  style="background: #E5ECF6;">
						    <div class="app-card-body p-3 p-lg-4  flex items-center justify-between">
						    	<div>
							    <h4 class="stats- mb-1 text-md font-bold">All Users</h4>
							    <div class="stats-  text-lg font-extrabold text-black"><?php $select_alluser="SELECT count(*) as countalluser FROM users";
							    $prepare_alluser = $connect -> prepare($select_alluser);
							    $prepare_alluser -> execute();
							    $fetch_alluser = $prepare_alluser -> fetch(PDO::FETCH_ASSOC);
							    echo $fetch_alluser['countalluser']; ?></div>
							</div>
